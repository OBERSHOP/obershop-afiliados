...
import { RecoverLoginForm } from "@/components/auth/RecoverLoginForm/RecoverLoginForm";
    ...
    <div className="flex w-full min-h-screen items-center justify-center bg-primary">
      <div className="w-full flex items-center justify-center lg:w-1/3">
        <Card className="w-full max-w-md shadow-none border-none bg-primary">
          <CardHeader>
            <CardTitle className="text-center text-xl text-secondary">Recuperar a senha</CardTitle>
          </CardHeader>
          <CardContent>
            <RecoverLoginForm />
          </CardContent>
